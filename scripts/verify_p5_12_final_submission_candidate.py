"""Verify frozen P5-12 candidate plus explicitly versioned Phase 6 documentation overlays."""
...
def verify_ci_structure():
    ...
    required = [
        "permissions:", "contents: read", 'python-version: "3.12"',
        "verify_p5_05_final_baseline.py", "verify_p5_06_acceptance_corrected_baseline.py",
        "validate_operator_interface.py", "verify_p5_12_operator_hardening.py",
        "verify_p5_12_final_submission_candidate.py", "tests.test_p5_12_final_submission_candidate",
...
def main():
    ...
    _, p6_paths, doc_entries, ci_entries, overlay_ids = load_versioned_post_freeze_overlays()
    ...
    print(f"Strict paths superseded only by versioned Phase 6 overlays: {superseded}")
    ...
    print("P5-12 final candidate with Phase 6 documentation overlays: PASS")
